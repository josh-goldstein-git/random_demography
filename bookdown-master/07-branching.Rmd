...
# Outline 
  ...
  \item The Galton-Watson-Bienaym\'e Process
  \item A viral example, simulating a branching process, our questionsThe distribution of the 2nd generation
  \item Moment generating functions
  \item Extinction probabilities
  \item The distribution of offspring of all generations
  \item A tractable offspring distribution
...
\item branching processes (``parents producing children''), next
...
```{r}
phone_table <- rbind(c(0,.3,"0-2"),
               c(1,.4,"3-5"),
               c(2,.3,"6-9"))
colnames(phone_table) <- c("k","p_k","digits")
knitr::kable(
  phone_table, booktabs = TRUE,
