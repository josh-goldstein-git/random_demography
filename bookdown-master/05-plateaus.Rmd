...
## Heterogeneity slows mortality improvement 
  ...
  We take the log and the time-derivative of hazards  give V&M (39*)
  $$ 
  \rho(x,t) = \rho_0(x,t) - \sigma^2 {d \over dt} \log
  \bar{S}_c(x,t)^{\sigma^2}
  $$ 

> Note: this formula should be correct. V&M contains a mistake: an extra minus sign in the definition of   $\bar{S}_c(x,t)$. 
...
```{r plateauhoriuchi, echo=FALSE, fig.align='center', fig.cap='Hazards across selected species. Source: @horiuchi2003', fig.height=5, out.width='80%'}
...
```{r echo=TRUE, fig.align='center', fig.cap='Hazards and plateau with Gamma frailty', out.width='80%'}
    #Plot:
...
```{r echo=TRUE, fig.height=6, message=FALSE, fig.cap ='Changing values of beta in Gompertz hazards', fig.align='center'}
par(mfrow=c(2,3))
...
```{r echo=TRUE, fig.height=6, fig.cap = 'Changing values of k (Gamma shape parameter)', fig.align='center'}
par(mfrow=c(2,3))
