...
legend("topleft", legend = c("baseline", "obs if s2 = .2^2", "obs if s2 = .5^2", "obs if s2 = 1^2"),
       col = "red", lty = 1:4)
mtext("Italian Females, born 1915", side = 3, line = -1.3, cex = 1.3, outer = TRUE)
```
...
##       col = c("red","blue"),
       lty = 1:2)
mtext(expression("Italian Females vs Males born 1915 " * sigma^2 == .5^2),
      side = 3, line = -1.3, cex = 1.3, outer = TRUE)
```
