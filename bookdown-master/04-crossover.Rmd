...
### A result: \vr (5E - V&M (38))
  ...
  - If variances are equal. What happens at age 0? What happens
    at very old ages.
  - If the higher mortality group has bigger frailty variance, what
    happens at older ages?
  - Same if  higher mortality group has smaller frailty
    variance?
...
```{r fig.height=6, warning=FALSE, fig.align='center', fig.cap='Italian Females vs Males, born 1915 $\\sigma^2=.5^2=.2^2=1^2$' }
par(mfrow = c(1,2))
...
```{r fig.height=6, warning=FALSE, fig.align='center', fig.cap='Italian Females vs Males, born 1915 $\\sigma^2=.5^2$' }
par(mfrow = c(1,2))
## title("Cumulative Hazards\n Italian Females born 1915")
foo <- my.dt[, plot(Age, log(h.f), type = "l", ylim = c(-7, 2), col = "red",
                    main = "Observed vs. implied baseline")]
